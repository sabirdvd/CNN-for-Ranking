...
#word2vec = None
word2vec = '/Users/asabir/Desktop/CNN-Ranking-master/data/w2v/GoogleNews-vectors-negative300.bin'
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Output directory for models and summaries (added)
            timestamp = str(int(time.time()))
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs", timestamp))
            print("Writing to {}\n".format(out_dir))


            # Write vocabulary (added)
            ...
            # load any vectors from the word2vec
                 print("/Users/asabir/Desktop/CNN-Ranking-master/data/w2v/".format(word2vec))
            ...
            # Generate batches
            batches = batch_iter(
                list(zip(x_left_train, x_right_train, y_train)), 64, 1000)
                #list(zip(x_left_train, x_right_train, y_train)), 64, 200)
            '''
